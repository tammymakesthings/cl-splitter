# -*- coding: utf-8 -*-
#
# cl-splitter documentation build configuration file, created by
...
htmlhelp_basename = 'cl-splitterdoc'
...
latex_documents = [
  ('index', 'cl-splitter.tex', u'cl-splitter Documentation',
   u'', 'manual'),
]
...
man_pages = [
    ('index', 'cl-splitter', u'cl-splitter Documentation',
     [u''], 1)
]
